...
function checkFormula(formulaTxt){
    ...
    if(result) {
        ...
        updateStatusMsg(stringConst.errorMsg);
    }
...
function calcExp(operand1, operand2, operator){
    operand1 = (Number(operand1) == NaN ? Number(operand1) : operand1 );
    operand2 = (Number(operand2) == NaN ? Number(operand2) : operand2 );
    console.log('1', typeof operand1);
    console.log('2', typeof operand2);
